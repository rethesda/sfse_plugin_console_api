...
namespace game
{
	...
	public:
		...
		private:
			static const std::uintptr_t rva = 0x0189D6E0; // 0x0189D450
		...
		private:
			static const std::uintptr_t rva = 0x01EA4B6F; // 0x01EA48DF
		...
		private:
			static const std::uintptr_t rva = 0x01EAD849; // 0x01EAD5B9
