...
#ifdef _DEBUG
#pragma comment(lib, "../../ianpatt/sfse/build/sfse/sfse_common/Debug/sfse_common.lib")
#else
#pragma comment(lib, "../../ianpatt/sfse/build/sfse/sfse_common/Release/sfse_common.lib")
#endif

#define PLUGIN_API						__declspec(dllexport)
#define PLUGIN_NAME						"sfse_plugin_console_api"
#define PLUGIN_AUTHOR					"stonegdi"
#define PLUGIN_COMPATIBLE_VERSIONS		{ RUNTIME_VERSION_1_16_236, 0 }
